...
for cc=1:length(Ccrown)
    ...
    if ZR_L(cc) > 0
        ...
        %%%% Testing variable
        test_var = {B_Ltm1(cc,:),PHE_S_Ltm1(cc),dflo_Ltm1(cc),AgeL_Ltm1(cc),AgeDL_Ltm1(cc),...
            Ta24,Tdp_L24(cc,:),PAR24,Psi_x_L24(cc,:),Psi_l_L24(cc,:), ...
            An_L24(cc,:),Rdark_L24(cc,:),NPP_Ltm1(cc),jDay,Datam,...
            NPPI_Ltm1(cc),TdpI_Ltm1(cc),Bfac_weekLtm1(cc),NupI_Ltm1(cc,:),NavlI, ...
            PARI_Ltm1(cc,:),NBLI_Ltm1(cc),NBLeaf_Ltm1(cc),L_day,Lmax_day, ...
            VegL_Param_Dyn,cc,Nreserve_Ltm1(cc),Preserve_Ltm1(cc),Kreserve_Ltm1(cc), ...
            Nuptake_L(cc), Puptake_L(cc),Kuptake_L(cc),FNC_Ltm1(cc),Se_bio, ...
            Tdp_bio,ParEx_L(cc),ExEM,Bam,Bem, ...
            Mpar_L(cc), TBio_L(cc),OPT_EnvLimitGrowth,OPT_VCA,OPT_VD, ...
        ...
        [LAI_L(cc),B_L(cc,:),NPP_L(cc),ANPP_L(cc),Rg_L(cc),RA_L(cc),Rms_L(cc),Rmr_L(cc),Rmc_L(cc),PHE_S_L(cc),...
            ...
            VEGGIE_UNIT( ...
            B_Ltm1(cc,:),PHE_S_Ltm1(cc),dflo_Ltm1(cc),AgeL_Ltm1(cc),AgeDL_Ltm1(cc),...
            Ta24,Tdp_L24(cc,:),PAR24,Psi_x_L24(cc,:),Psi_l_L24(cc,:), ...
            An_L24(cc,:),Rdark_L24(cc,:),NPP_Ltm1(cc),jDay,Datam,...
            NPPI_Ltm1(cc),TdpI_Ltm1(cc),Bfac_weekLtm1(cc),NupI_Ltm1(cc,:),NavlI, ...
            PARI_Ltm1(cc,:),NBLI_Ltm1(cc),NBLeaf_Ltm1(cc),L_day,Lmax_day, ...
