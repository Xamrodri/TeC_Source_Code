...
%%%%%%%%%%%%%%%%%%%%
%%% MAX CHECK
guidance_SVAT_UNIT = struct('Tstm0',Tstm0,'Pr',Pr, ...
'Ta',Ta,'Ds',Ds, 'Ws',Ws,'zatm',zatm, 'Tstm1',Tstm1, 'Tstm1_under',Tstm1_under, ...
'dt',dt,'ea',ea, 'Latm',Latm,'N',N, 'Pre',Pre, 'OS',OS, ...
'Psi_s_H',Psi_s_H,'Psi_s_L',Psi_s_L, 'gsr_H',gsr_H,'gsr_L',gsr_L, ...
'Exwat_H',Exwat_H, 'Exwat_L', Exwat_L, 'LAI_H', LAI_H, 'SAI_H',SAI_H, ...
'LAI_L',LAI_L,'SAI_L',SAI_L, 'LAIdead_H',LAIdead_H, 'LAIdead_L',LAIdead_L, ...
'BLit',BLit,'Sllit',Sllit, 'Kct',Kct,'TminS',TminS, ...
'TmaxS',TmaxS, 'Sp_SN_In',Sp_SN_In, 'Sp_LAI_L_In',Sp_LAI_L_In,'Sp_LAI_H_In',Sp_LAI_H_In, ...
'h_S',h_S, 'Ccrown', Ccrown, 'Cbare',Cbare,'Crock',Crock, 'Curb',Curb,'Cwat',Cwat, ...
'ydepth',ydepth,'Ccrown_L',Ccrown_L, 'Rsw', Rsw, 'PAR',PAR,'SvF',SvF, ...
'SNDtm1',SNDtm1,'snow_albtm1',snow_albtm1,'Color_Class',Color_Class,'OM_H',OM_H, 'OM_L',OM_L,...
'PFT_opt_H',PFT_opt_H,'PFT_opt_L',PFT_opt_L,'hc_H',hc_H,'hc_L',hc_L,'d_leaf_H',d_leaf_H,'d_leaf_L',d_leaf_L,...
'r_soil', r_soil,'b_soil',b_soil,'alp_soil',alp_soil,'gcI',gcI,'KcI',KcI,'KnitH', KnitH,'KnitL',KnitL, ...
'mSl_H', mSl_H,'Sl_H',Sl_H,'mSl_L',mSl_L,'Sl_L',Sl_L,'Ca',Ca,'Oa',Oa,'Citm1_sunH',Citm1_sunH,'Citm1_shdH',Citm1_shdH, ...
'CT_H',CT_H,'Citm1_sunL',Citm1_sunL,'Citm1_shdL',Citm1_shdL,'CT_L',CT_L,'Vmax_H',Vmax_H,'Vmax_L',Vmax_L,'FI_H',FI_H, ...
'FI_L',FI_L,'a1_H',a1_H,'go_H',go_H,'a1_L',a1_L,'go_L',go_L,'DSE_H',DSE_H,'Ha_H',Ha_H,'Do_H',Do_H, ...
'e_rel_H',e_rel_H,'e_relN_H',e_relN_H,'DSE_L',DSE_L,'Ha_L',Ha_L,'Do_L',Do_L,'e_rel_L',e_rel_L,'e_relN_L',e_relN_L, ...
'gmes_H',gmes_H,'rjv_H',rjv_H,'gmes_L',gmes_L,'rjv_L',rjv_L,'e_snotm1',e_snotm1,'In_Htm1',In_Htm1, ...
'In_Ltm1',In_Ltm1,'In_Littertm1',In_Littertm1,'In_urbtm1',In_urbtm1,'In_rocktm1',In_rocktm1,'SWEtm1',SWEtm1, ...
'In_SWEtm1',In_SWEtm1, 'Oicetm1',Oicetm1,'Otm1',Otm1,'Tdptm1',Tdptm1,'Tdpsnowtm1',Tdpsnowtm1, ...
'Tdamptm1',Tdamptm1,'Ticetm1',Ticetm1,'dz',dz,'Zs',Zs,'ms',ms,'rsd',rsd,'lan_dry',lan_dry,'lan_s',lan_s, ...
'cv_s',cv_s,'SPAR',SPAR,'L',L,'Pe',Pe,'O33',O33,'alpVG',alpVG,'nVG',nVG,'Phy',Phy,'s_SVG',s_SVG,'bVG',bVG, ...
'Osat',Osat,'Ohy',Ohy,'CTt',CTt,'lan_oth',lan_oth,'cv_oth',cv_oth,'CTt_oth',CTt_oth,'Zs_deb',Zs_deb, ...
'Deb_Par',Deb_Par,'Tdebtm1',Tdebtm1,'Tdew',Tdew,'t_slstm1',t_slstm1,'rostm1',rostm1,'SP_wctm1',SP_wctm1, ...
'fpr',fpr,'WatFreez_Th',WatFreez_Th,'dz_ice',dz_ice, 'Pr_sno_day', Pr_sno_day,'Th_Pr_sno',Th_Pr_sno, ...
'ros_max1',ros_max1,'ros_max2',ros_max2,'Urb_Par', Urb_Par,'In_max_urb',In_max_urb,'In_max_rock',In_max_rock, ...
'tau_snotm1',tau_snotm1,'Ta_day',Ta_day,'Ws_undertm1',Ws_undertm1,'EvL_Zs',EvL_Zs,'RfH_Zs',RfH_Zs, ...
'RfL_Zs',RfL_Zs,'Vtm1',Vtm1,'WATtm1',WATtm1,'ICEtm1',ICEtm1,'IP_wctm1',IP_wctm1,'ICE_Dtm1',ICE_Dtm1, ...
'Ice_wc_sp',Ice_wc_sp,'ros_Ice_thr',ros_Ice_thr,'Aice',Aice,'Cicewtm1',Cicewtm1,'Vxtm1_H',Vxtm1_H, ...
'Vltm1_H',Vltm1_H,'Vxtm1_L',Vxtm1_L,'Vltm1_L',Vltm1_L,'Psi_xtm1_H',Psi_xtm1_H,'Psi_ltm1_H',Psi_ltm1_H, ...
'Psi_xtm1_L',Psi_xtm1_L,'Psi_ltm1_L',Psi_ltm1_L,'Psi_sto_50_H',Psi_sto_50_H,'Psi_sto_00_H',Psi_sto_00_H, ...
'ZR95_H',ZR95_H,'Psi_sto_50_L',Psi_sto_50_L,'Psi_sto_00_L',Psi_sto_00_L,'ZR95_L',ZR95_L,...
'Axyl_H',Axyl_H,'PsiL50_H',PsiL50_H,'PsiL00_H',PsiL00_H,'Kleaf_max_H',Kleaf_max_H,'Cl_H',Cl_H, ...
'Kx_max_H',Kx_max_H,'PsiX50_H',PsiX50_H,'Cx_H',Cx_H, 'Axyl_L', Axyl_L,'PsiL50_L',PsiL50_L,'PsiL00_L',PsiL00_L, ...
'Kleaf_max_L',Kleaf_max_L,'Cl_L',Cl_L,'Kx_max_L',Kx_max_L,'PsiX50_L',PsiX50_L,'Cx_L',Cx_L,...
'min_SPD', min_SPD,'OPT_VegSnow',OPT_VegSnow,'OPT_SoilTemp',OPT_SoilTemp,'OPT_PlantHydr',OPT_PlantHydr, ...
'Opt_CR',Opt_CR,'Opt_ST',Opt_ST,'Opt_ST2',Opt_ST2,'OPT_STh',OPT_STh,'OPT_FR_SOIL',OPT_FR_SOIL, ...
'OPT_PH',OPT_PH, 'parameterize_phase', parameterize_phase, 'hSTL', hSTL, 'Albsno_method', Albsno_method);

% Get the current datetime
current_time = datetime('now');
% Extract the time components
my_hour = hour(current_time);
my_minute = minute(current_time);
my_second = second(current_time);

save(strcat('M:/19_ISTA/1_TC/3_Model_Source/TeC_Source_Code/European_catchments/Pyrenees_distributed/Guidance/' ...
    ,num2str(my_hour),'_', num2str(my_minute),'_', num2str(round(my_second)),'_gg_SVAT_UNIT.mat'), 'guidance_SVAT_UNIT');
