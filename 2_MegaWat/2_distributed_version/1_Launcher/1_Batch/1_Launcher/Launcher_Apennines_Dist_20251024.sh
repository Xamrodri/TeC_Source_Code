...
srun matlab -nodisplay -nodesktop -nosplash -r "clear all; delete(gcp('nocreate')); s=2; fnum=1; run('/nfs/scistore18/pelligrp/mrodrigu/1_TC/3_Model_Source/2_MegaWat/2_distributed_version/1_Launcher/Launcher_Apennines_Distributed.m');exit;" | tail -n +11
