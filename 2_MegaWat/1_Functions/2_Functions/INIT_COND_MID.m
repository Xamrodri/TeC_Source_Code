...
function [] = INIT_COND_MID(t_reini, Directories, ...
...
%% Storing
save([Directories.save 'Store/State_Conditions_' char(num2str(day(t_reini))) '_' char(string(t_store, 'MMM')) '_' char(num2str(year(t_reini))) '.mat'], ... 
...
disp(['Variables correctly saved for ' char(num2str(day(t_reini))) '_' char(string(t_reini,'MMM')) '_' char(num2str(year(t_reini))) ])
