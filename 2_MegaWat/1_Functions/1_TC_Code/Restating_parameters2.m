...
if not(exist('Vmax_H','var'))
    VegH_Param.KnitH=NaN*ones(1,cc_aux);
    VegH_Param.mSl_H=NaN*ones(1,cc_aux);
    VegH_Param.Sl_H=NaN*ones(1,cc_aux);
    VegH_Param.CT_H=NaN*ones(1,cc_aux);
    VegH_Param.Vmax_H=NaN*ones(1,cc_aux);
    VegH_Param.FI_H=NaN*ones(1,cc_aux);
    VegH_Param.a1_H=NaN*ones(1,cc_aux);
    VegH_Param.go_H=NaN*ones(1,cc_aux);
    VegH_Param.DSE_H=NaN*ones(1,cc_aux);
    VegH_Param.Ha_H=NaN*ones(1,cc_aux);
    VegH_Param.Do_H=NaN*ones(1,cc_aux);
    VegH_Param.gmes_H=NaN*ones(1,cc_aux);
    VegH_Param.rjv_H=NaN*ones(1,cc_aux);
    VegH_Param.Psi_sto_50_H=NaN*ones(1,cc_aux);
    VegH_Param.Psi_sto_00_H=NaN*ones(1,cc_aux);
    VegH_Param.Axyl_H=NaN*ones(1,cc_aux);
    VegH_Param.PsiL50_H=NaN*ones(1,cc_aux);
    VegH_Param.PsiL00_H=NaN*ones(1,cc_aux);
    VegH_Param.Kleaf_max_H=NaN*ones(1,cc_aux);
    VegH_Param.Cl_H=NaN*ones(1,cc_aux);
    VegH_Param.Kx_max_H=NaN*ones(1,cc_aux);
    VegH_Param.PsiX50_H=NaN*ones(1,cc_aux);
    VegH_Param.Cx_H=NaN*ones(1,cc_aux);
else
...
if not(exist('Osm_reg_Max_H','var'))
    VegH_Param.Osm_reg_Max_H = 0*ones(1,cc_aux);
    VegH_Param.eps_root_base_H=  0.9*ones(1,cc_aux);
else
...
if not(exist('Vmax_L','var'))
    VegL_Param.KnitL=NaN*ones(1,cc_aux);
    VegL_Param.mSl_L=NaN*ones(1,cc_aux);
    VegL_Param.Sl_L=NaN*ones(1,cc_aux);
    VegL_Param.CT_L=NaN*ones(1,cc_aux);
    VegL_Param.Vmax_L=NaN*ones(1,cc_aux);
    VegL_Param.FI_L=NaN*ones(1,cc_aux);
    VegL_Param.a1_L=NaN*ones(1,cc_aux);
    VegL_Param.go_L=NaN*ones(1,cc_aux);
    VegL_Param.DSE_L=NaN*ones(1,cc_aux);
    VegL_Param.Ha_L=NaN*ones(1,cc_aux);
    VegL_Param.Do_L=NaN*ones(1,cc_aux);
    VegL_Param.gmes_L=NaN*ones(1,cc_aux);
    VegL_Param.rjv_L=NaN*ones(1,cc_aux);
    VegL_Param.Psi_sto_50_L = NaN*ones(1,cc_aux);
    VegL_Param.Psi_sto_00_L=NaN*ones(1,cc_aux);
    VegL_Param.Axyl_L=NaN*ones(1,cc_aux);
    VegL_Param.PsiL50_L=NaN*ones(1,cc_aux);
    VegL_Param.PsiL00_L=NaN*ones(1,cc_aux);
    VegL_Param.Kleaf_max_L= NaN*ones(1,cc_aux);
    VegL_Param.Cl_L=NaN*ones(1,cc_aux);
    VegL_Param.Kx_max_L=NaN*ones(1,cc_aux);
    VegL_Param.PsiX50_L=NaN*ones(1,cc_aux);
    VegL_Param.Cx_L=NaN*ones(1,cc_aux);
else
...
if not(exist('Osm_reg_Max_L','var'))
    VegL_Param.Osm_reg_Max_L = 0*ones(1,cc_aux);
    VegL_Param.eps_root_base_L=  0.9*ones(1,cc_aux);
else
...
if not(exist('aSE_H','var'))
    VegH_Param_Dyn.Sl = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.mSl = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.Stoich = Stoich_H;
    VegH_Param_Dyn.r =NaN*ones(1,cc_aux);
    VegH_Param_Dyn.gR = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.LtR = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.eps_ac = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.aSE = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.Trr = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.dd_max = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.dc_C = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.Tcold = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.drn = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.dsn= NaN*ones(1,cc_aux);
    VegH_Param_Dyn.age_cr = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.Bfac_lo = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.Bfac_ls = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.Tlo= NaN*ones(1,cc_aux);
    VegH_Param_Dyn.Tls = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.mjDay = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.LDay_min =NaN*ones(1,cc_aux);
    VegH_Param_Dyn.dmg= NaN*ones(1,cc_aux);
    VegH_Param_Dyn.Mf = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.Wm =NaN*ones(1,cc_aux);
    VegH_Param_Dyn.LAI_min =NaN*ones(1,cc_aux);
    VegH_Param_Dyn.LDay_cr= NaN*ones(1,cc_aux);
    VegH_Param_Dyn.PsiG50 = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.PsiG99 =NaN*ones(1,cc_aux);
    VegH_Param_Dyn.gcoef =NaN*ones(1,cc_aux);
    VegH_Param_Dyn.fab= NaN*ones(1,cc_aux);
    VegH_Param_Dyn.fbe = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.Klf =NaN*ones(1,cc_aux);
    VegH_Param_Dyn.ff_r = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.PAR_th =NaN*ones(1,cc_aux);
    VegH_Param_Dyn.PsiL50 = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.PsiL00 = NaN*ones(1,cc_aux);
else
...
if not(exist('soCrop_H','var'))
    VegH_Param_Dyn.soCrop = NaN*ones(1,cc_aux);
    VegH_Param_Dyn.MHcrop=  NaN*ones(1,cc_aux);
    VegH_Param_Dyn.Sl_emecrop=  NaN*ones(1,cc_aux);
else
...
if not(exist('aSE_L','var'))
    VegL_Param_Dyn.Sl = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.mSl = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.Stoich = Stoich_L;
    VegL_Param_Dyn.r = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.gR = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.LtR = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.eps_ac = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.aSE = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.Trr = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.dd_max = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.dc_C = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.Tcold = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.drn = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.dsn = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.age_cr = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.Bfac_lo = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.Bfac_ls = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.Tlo= NaN*ones(1,cc_aux);
    VegL_Param_Dyn.Tls = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.mjDay = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.LDay_min =NaN*ones(1,cc_aux);
    VegL_Param_Dyn.dmg= NaN*ones(1,cc_aux);
    VegL_Param_Dyn.Mf = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.Wm = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.LAI_min =NaN*ones(1,cc_aux);
    VegL_Param_Dyn.LDay_cr= NaN*ones(1,cc_aux);
    VegL_Param_Dyn.PsiG50 = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.PsiG99 =NaN*ones(1,cc_aux);
    VegL_Param_Dyn.gcoef =NaN*ones(1,cc_aux);
    VegL_Param_Dyn.fab= NaN*ones(1,cc_aux);
    VegL_Param_Dyn.fbe = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.Klf =NaN*ones(1,cc_aux);
    VegL_Param_Dyn.ff_r =NaN*ones(1,cc_aux);
    VegL_Param_Dyn.PAR_th =NaN*ones(1,cc_aux);
    VegL_Param_Dyn.PsiL50 = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.PsiL00 = NaN*ones(1,cc_aux);
else
...
if not(exist('soCrop_L','var'))
    VegL_Param_Dyn.soCrop = NaN*ones(1,cc_aux);
    VegL_Param_Dyn.MHcrop=  NaN*ones(1,cc_aux);
    VegL_Param_Dyn.Sl_emecrop=  NaN*ones(1,cc_aux);
else
