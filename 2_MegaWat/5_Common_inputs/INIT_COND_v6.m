...
r_littertm1=    zeros(num_cell,5);; % Litter resistance [s/m]
...
cc_size = 1:length(POI.Ccrowns{z});
type = POI.Veg_type{z};
...
AgeL_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'AgeL_Ltm1'),type)),length(id),1);

%% AgeDL: Dead leaf Age [days] (NO REFERENCE)
AgeDL_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'AgeDL_Htm1'),type)),length(id),1);
AgeDL_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'AgeDL_Ltm1'),type)),length(id),1);

%% AgePl: Age of the forest stand or plantation [days] (NO REFERENCE)
AgePl_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'AgePl_Htm1'),type)),length(id),1);
AgePl_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'AgePl_Ltm1'),type)),length(id),1);

%% Bfac_week: Plant stress factor integrated at the weekly scale [0-1] (NO REFERENCE)
Bfac_weekHtm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Bfac_weekHtm1'),type)),length(id),1);
Bfac_weekLtm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Bfac_weekLtm1'),type)),length(id),1);

%% Ci_sun: CO2 sunlit leaf internal concentration [umolCO2/mol] (NO REFERENCE)
Citm1_sunH(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Citm1_sunH'),type)),length(id),1);
Citm1_sunL(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Citm1_sunL'),type)),length(id),1);

%% Ci_shd:  CO2 sunlit leaf internal concentration [umolCO2/mol] (NO REFERENCE)
Citm1_shdH(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Citm1_shdH'),type)),length(id),1);
Citm1_shdL(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Citm1_shdL'),type)),length(id),1);

%% dflo:  Days from leaf onset [days] (FROM REFERENCE)
dflo_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'dflo_Htm1'),type)),length(id),1);
dflo_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'dflo_Ltm1'),type)),length(id),1);

%% e_rel: Relative Efficiency of the photosynthesis apparatus due to Age/Day-length (FROM REFERENCE)
e_rel_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'e_rel_Htm1'),type)),length(id),1);
e_rel_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'e_rel_Ltm1'),type)),length(id),1);

%% e_relN:       Relative Efficiency of the photosynthesis apparatus due to N Limitations (NO REFERENCE)
e_relN_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'e_relN_Htm1'),type)),length(id),1);
e_relN_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'e_relN_Ltm1'),type)),length(id),1);

%% FNC: Nitrogen Stress Factor for vegetation [0-1] (FROM REFERENCE)
FNC_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'FNC_Htm1'),type)),length(id),1);
FNC_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'FNC_Ltm1'),type)),length(id),1);

%% hc: Vegetation Height [m] (FROM REFERENCE)
hc_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'hc_Htm1'),type)),length(id),1);
hc_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'hc_Ltm1'),type)),length(id),1);

%% Kreserve: Mobile Reserve of Potassium in vegetation [gK/m2 PFT] (FROM REFERENCE)
Kreserve_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Kreserve_Htm1'),type)),length(id),1);
Kreserve_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Kreserve_Ltm1'),type)),length(id),1);

%% LAI: Leaf area index [-] (NO REFERENCE)
LAI_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'LAI_Htm1'),type)),length(id),1);
LAI_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'LAI_Ltm1'),type)),length(id),1);

%% NBLeaf: New Leaf Biomass [gC/m2 day] (NO REFERENCE)
NBLeaf_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NBLeaf_Htm1'),type)),length(id),1);
NBLeaf_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NBLeaf_Ltm1'),type)),length(id),1);

%% NBLI: Integral of New Leaf Biomass over 30 days [gC/m2 day] (NO REFERENCE)
NBLI_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NBLI_Htm1'),type)),length(id),1);
NBLI_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NBLI_Ltm1'),type)),length(id),1);
 
%% NPP:  Net Primary Production [gC/m2 PFT day] (NO REFERENCE)
NPP_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NPP_Htm1'),type)),length(id),1);
NPP_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NPP_Ltm1'),type)),length(id),1);
 
%% NPII: Integral of Net Primary Production over 7 days [gC/m2 PFT day] (NO REFERENCE)
NPPI_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NPPI_Htm1'),type)),length(id),1);
NPPI_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NPPI_Ltm1'),type)),length(id),1);

%% Nreserve: Mobile Reserve of Nitrogen in vegetation [gN/m2 PFT] (FROM REFERENCE)
Nreserve_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Nreserve_Htm1'),type)),length(id),1);
Nreserve_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Nreserve_Ltm1'),type)),length(id),1);

%% PHE: Phenology State [#] (FROM REFERENCE)
PHE_S_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'PHE_S_Htm1'),type)),length(id),1);
PHE_S_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'PHE_S_Ltm1'),type)),length(id),1);

%% Preserve: Mobile Reserve of Phosporus in vegetation [gP/m2 PFT] (FROM REFERENCE)
Preserve_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Preserve_Htm1'),type)),length(id),1);
Preserve_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Preserve_Ltm1'),type)),length(id),1);

%% Psi_x:        Soil water potential in the stem xylem [MPa] (NO REFERENCE)
Psi_x_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Psi_x_Htm1'),type)),length(id),1);
Psi_x_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Psi_x_Ltm1'),type)),length(id),1);

%% Psi_l:        Leaf water potential in the leaves [MPa] (NO REFERENCE)
Psi_l_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Psi_l_Htm1'),type)),length(id),1);
Psi_l_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Psi_l_Ltm1'),type)),length(id),1);

%% SAI: Stem area index [-] (FROM REFERENCE)
SAI_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'SAI_Htm1'),type)),length(id),1);
SAI_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'SAI_Ltm1'),type)),length(id),1);

%% TBio: Total standing biomass temporally variable [ton DM / ha ] (FROM REFERENCE)
TBio_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'TBio_Htm1'),type)),length(id),1);
TBio_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'TBio_Ltm1'),type)),length(id),1);

%% Tden: Tree density, High vegetation [n*ind/ ha] (NO REFERENCE)
Tden_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Tden_Htm1'),type)),length(id),1);
Tden_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Tden_Ltm1'),type)),length(id),1);

%% Vx: Water Volume in the xylem [mm m2 ground/m2 PFT] (FROM REFERENCE)
Vx_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Vx_Htm1'),type)),length(id),1);
Vx_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Vx_Ltm1'),type)),length(id),1);

%% Vl:           Water Volume in the leaves [mm m2 ground/m2 PFT] (FROM REFERENCE)
Vl_Htm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Vl_Htm1'),type)),length(id),1);
Vl_Ltm1(id,cc_size) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'Vl_Ltm1'),type)),length(id),1);

%% NupI:         Integrated Nitrogen|Phosphorous|Potassium uptake over 365 days [gX/m2 PFT day] (FROM REFERENCE)
NupI_Htm1(id,cc_size,1) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NupI_Htm1'),type)),length(id),1);
NupI_Ltm1(id,cc_size,1) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NupI_Ltm1'),type)),length(id),1);

NupI_Htm1(id,cc_size,2) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NupI_Htm1'),type)),length(id),1);
NupI_Ltm1(id,cc_size,2) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NupI_Ltm1'),type)),length(id),1);

NupI_Htm1(id,cc_size,3) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NupI_Htm1'),type)),length(id),1);
NupI_Ltm1(id,cc_size,3) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NupI_Ltm1'),type)),length(id),1);

%% NupLit:       Nitrogen|Phosphorous|Potassium content in the litter [gN/m2 PFT] (NO REFERENCE)
NupLit_Htm1(id,cc_size,1) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NupLit_Htm1'),type)),length(id),1);
NupLit_Ltm1(id,cc_size,1) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NupLit_Ltm1'),type)),length(id),1);

NupLit_Htm1(id,cc_size,2) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NupLit_Htm1'),type)),length(id),1);
NupLit_Ltm1(id,cc_size,2) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NupLit_Ltm1'),type)),length(id),1);

NupLit_Htm1(id,cc_size,3) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NupLit_Htm1'),type)),length(id),1);
NupLit_Ltm1(id,cc_size,3) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'NupLit_Ltm1'),type)),length(id),1);
...
PARI_Htm1(id,cc_size,1) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'PARI_Htm1'),type)),length(id),1);
PARI_Ltm1(id,cc_size,1) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'PARI_Ltm1'),type)),length(id),1);

PARI_Htm1(id,cc_size,2) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'PARI_Htm1'),type)),length(id),1);
PARI_Ltm1(id,cc_size,2) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'PARI_Ltm1'),type)),length(id),1);

PARI_Htm1(id,cc_size,3) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'PARI_Htm1'),type)),length(id),1);
PARI_Ltm1(id,cc_size,3) = repmat(table2array(TT_par(strcmp(TT_par.Parameters,'PARI_Ltm1'),type)),length(id),1);
...
B_Htm1(:,:,1)= 310;  % Foliage 
B_Htm1(:,:,2)= 556;  % Liv. Sapwwod
B_Htm1(:,:,3)= 406;  % Carbohydrate reserve
B_Htm1(:,:,4)= 411;  % Fruit and Flowers
B_Htm1(:,:,5)= 7;    % Heartwood/Dead sapwood
B_Htm1(:,:,6)= 0;    % Standing dead foliage
B_Htm1(:,:,7)= 16;   % Aux
B_Htm1(:,:,8)= 0;    % High vegetation
