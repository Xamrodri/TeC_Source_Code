...
function[DT]=Surface_Temperature_Snow(Ts,dt,Ta,ea,Latm,SvF,Pre,...
    ...
    Tdew,t_slstm1,SWEtm1,Dtm1,rostm1,SP_wctm1,In_SWEtm1,fpr,Vavail,Vavail_plant_H,Vavail_plant_L,WAT_avail,ICEtm1,OPT_VegSnow,min_SPD,TsV,hSTL)
%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%
...
if (Dtm1) > min_SPD
    ...
    [TsF]=Snowpacks_2layers(dt,...
        ...
        Pr_liq,Pr_sno,ESN,ESN_In,Rnet,H,QE,G,Qv,Csnow,Ccrown,Cwat,Cfol_H,fpr,Pr_sno_day,Th_Pr_sno,ros_max1,ros_max2,lan_sno,min_SPD,hSTL);
